# 2-images-as-background-gradio

Migrated from Hugging Face Spaces.

## Original Space

- URL: https://huggingface.co/spaces/Chris4K/2-images-as-background-gradio
- SDK: gradio
...
1. **Private Monorepo** (development)
   - Location: `apps/huggingface/2-images-as-background-gradio/`
   - All development happens here
   - Contains secrets and private configuration

2. **Public GitHub Repository**
   - URL: https://github.com/Ckal/2-images-as-background-gradio
